...
public class RandMove : MonoBehaviour
{
    ...
    public float minSpeed = 1;  // minimum range of speed to move
    public float maxSpeed = 5;  // maximum range of speed to move
    ...
    void Update()
    {
        ...
        timeVar += step;
        speed = 2;// Random.Range(minSpeed, maxSpeed);              //      Change this range of numbers to change speed
